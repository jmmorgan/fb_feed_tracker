...
module FbFeedTracker
  class Application < Rails::Application
    ...
    config.action_mailer.smtp_settings = config.settings["smtp_settings"]
    config.action_mailer.smtp_settings.symbolize_keys!
    config.send_emails = config.settings["send_emails"]

    config.ssl_required =  config.settings["ssl_required"]
  end
end
